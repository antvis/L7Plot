...
import { PolygonLayer as Polygon } from '@antv/l7-layers';
...
export class PolygonLayer<O extends IPolygonLayerOptions = IPolygonLayerOptions> extends BaseLayer<O> {
  /**
   * 默认配置项
   */
  ...
  constructor(options: O) {
    ...
    this.layer = new Polygon({ ...config, name: this.name });
   ...
   * 获取默认配置
   */
  public getDefaultOptions(): Partial<IPolygonLayerOptions> {
