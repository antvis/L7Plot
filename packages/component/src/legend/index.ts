...
import { LegendCustomContent, ILegendOptions } from '../types';
import { clearDom } from '../utils/dom';

export class Legend<O extends ILegendOptions = ILegendOptions> extends Component<O> {
  /**
   * 缓存 title DOM
   */
   ...
   */
  private renderCustomContent(customContent: LegendCustomContent) {
   ...
   * 生成自定义内容 DOM
   */
  private getHtmlContentNode(customContent: LegendCustomContent) {
