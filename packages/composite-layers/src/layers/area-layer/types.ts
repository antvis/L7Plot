import { PolygonLayerConfig } from '../../types/layer-config';
import { CompositeLayerOptions, ISourceCFG, Source } from '../../types';
...
export interface AreaLayerOptions
  extends Omit<PolygonLayerConfig, 'style' | 'state' | 'shape' | 'size'>,
