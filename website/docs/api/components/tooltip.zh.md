...
自定义 tooltip 内容，注意 <tag color="red" text="stringHTML | HTMLElemenct"></tag> 是 [HTMLElement](https://developer.mozilla.org/zh-CN/docs/Web/API/HTMLElement) 或拼接好的 HTML 字符串，不是纯文本类型。
