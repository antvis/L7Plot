...
| 事件名     | 类型     | 描述                                                                 |
| ---------- | -------- | -------------------------------------------------------------------- |
| mousemove  | 滑动事件 | 鼠标在地图上移动时触发                                               |
| mousewheel | 滑动事件 | 鼠标滚轮开始缩放地图时触发                                           |
| mouseover  | 滑动事件 | 鼠标移入地图容器内时触发                                             |
| mouseout   | 滑动事件 | 鼠标移出地图容器时触发                                               |
| mouseup    | 滑动事件 | 鼠标在地图上单击抬起时触发                                           |
| mousedown  | 滑动事件 | 鼠标在地图上单击按下时触发                                           |
