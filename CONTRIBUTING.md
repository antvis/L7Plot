...
If you have any comment or advice, please report your [issue](https://github.com/antvis/l7plot/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/l7plot/pulls).
...
Then you can create a Pull Request at [L7Plot](https://github.com/antvis/l7plot/pulls).
...
Document change on antvis/l7plot#123
...
- Open a new [Release Proposal MR], and write `History` as [node CHANGELOG]. Don't forget to correct content in documentation which is related to the releasing version.
